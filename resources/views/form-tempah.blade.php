                                ...
                                <div class="lg:col-span-1">
                                    ...
                                    <div class="mt-2">
										...
										<div class="flex items-center gap-x-3 mt-3">
											<input type="checkbox" name="hijri-date-is-on" id="hijri-date-is-on" value="1" {{ old('hijri-date-is-on') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
