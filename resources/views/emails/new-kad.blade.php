    ...
    <table width="100%" style="border-collapse: collapse; background-color: #ffffff; margin: 20px auto; max-width: 600px;">
        ...
        <tr>
            <td style="padding: 20px; text-align: left;">
                ...
                <p>Pakej: {{ $pakej }}</p>
                <a href="onlinekad.com/invitation/{{ $kadData['slug'] }}" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: #ffffff; text-decoration: none; border-radius: 4px;">
                    Check it out!! 
                </a>
            </td>
        </tr>
