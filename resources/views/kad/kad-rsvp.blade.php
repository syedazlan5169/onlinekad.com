        ...
        <div x-data="{ deleteModal: false , selectedRsvpId: '', selectedRsvpName: '' }" class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div>
                <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
                  ...
                  <div class="text-center overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
                    <dt class="truncate text-sm font-medium text-gray-500">Jumlah Hadir</dt>
                    <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">{{ $totalHadir }}</dd>
                  </div>
                  <div class="text-center overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
								...
								<table class="min-w-full divide-y divide-gray-300">
									<thead class="bg-gray-50">
										<tr>
											...
											<th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Kehadiran</th>
											<th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Telefon</th>
											<th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Jumlah Kehadiran</th>
										</tr>
									</thead>
									<tbody class="divide-y divide-gray-200 bg-white">
										...
										<tr>
											...
											<td class="whitespace-nowrap py-4 px-4 text-sm text-center font-medium border border-l text-gray-900 sm:px-6">{{ $entry->kehadiran }}</td>
