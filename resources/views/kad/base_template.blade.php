...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:description" content="{{ $kadData->is_english ? "You're invited to" : 'Anda dijemput hadir ke majlis' }} {{ $kadData->tajuk_kad }} {{ $kadData->nama_panggilan_lelaki }} & {{ $kadData->nama_panggilan_perempuan }} {{ $kadData->is_english ? 'on' : 'pada' }} {{ $dateTime['tarikh_majlis'] }} {{ $kadData->is_english ? 'at' : 'di' }} {{ $kadData->alamat_majlis }}.">
        ...
        <meta name="twitter:description" content="{{ $kadData->is_english ? "You're invited to" : 'Anda dijemput hadir ke' }} {{ $kadData->tajuk_kad }} {{ $kadData->nama_panggilan_lelaki }} & {{ $kadData->nama_panggilan_perempuan }} {{ $kadData->is_english ? 'on' : 'pada' }} {{ $dateTime['tarikh_majlis'] }} {{ $kadData->is_enlish ? 'at' : 'di' }} {{ $kadData->alamat_majlis }}.">
            ...
            <div class="h-screen w-full bg-cover bg-center" style="background-image: url('{{ asset($design->design_url_1) }}');">
                <div class="absolute inset-0 bg-white bg-opacity-20">
                    <div x-show="showModal == false || {{ $kadData->package_id }} == '1'" class="flex flex-col justify-center gap-16 items-center h-full">
                        ...
                        @else
                            <div class="text-center">
                                <p class="text-7xl text-gray-600 mb-0 leading-tight animate-zoom-in-delay-1" style="font-family: '{{ $font->font_name }}', cursive; color: {{ $primaryTextColor }}; padding-right: 0.25em;"> {{ $kadData->nama_panggilan_lelaki }}</p>
                                <p class="text-5xl text-gray-600 mb-0 leading-tight animate-zoom-in-delay-2" style="font-family: '{{ $font->font_name }}', cursive; color: {{ $primaryTextColor }};">&</p>
                                <p class="text-7xl text-gray-600 mb-0 leading-tight animate-zoom-in-delay-3" style="font-family: '{{ $font->font_name }}', cursive; color: {{ $primaryTextColor }}; padding-right: 0.25em;">{{ $kadData->nama_panggilan_perempuan }}</p>
                            </div>
                        @endif
                        <div class="text-center">
