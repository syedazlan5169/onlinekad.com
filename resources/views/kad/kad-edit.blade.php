					...
					<form action="/kad-update/{{ $kadData->id }}" method="POST" enctype="multipart/form-data">
						...
						<div id="maklumatMajlisSection" class="border rounded-md p-4 mb-4">
							...
							<div x-show="openSection === 'maklumatMajlis'" class="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
								...
								<div class="lg:col-span-4" x-data="{ selectedGreeting: '{{ $kadData->greeting_image }}' }">
								...
								<div class="lg:col-span-6">
									...
									<div class="mt-2">
										<input type="text" name="greeting-text" id="greeting-text" 
											value="{{ $kadData->greeting_text }}" 
						...
						<template x-if="packageId == 2 || packageId == 3">
							...
							<div x-data="{ giftEnabled: {{ $kadData->gift_is_on }} }" x-show="openSection === 'others'" class="mt-8">
                                <div>
                                    ...
                                    <div class="mt-2 mb-4 sm:flex sm:items-center sm:justify-between sm:px-20">
                                        ...
                                        <div x-data="{ enabled: {{ $kadData->doa_is_on }} }" class="flex items-center">
                                            <!-- Button Element -->
                                            <button 
                                                @click="enabled = !enabled" 
                                                :class="enabled ? 'bg-indigo-600' : 'bg-gray-200'" 
