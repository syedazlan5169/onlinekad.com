					...
					<div x-data="{
						...
						<form action="/kad-update/{{ $kadData->id }}" method="POST">
							...
							<div class="border rounded-md p-4 mb-4">
								...
								<div x-show="openSection === 'maklumat_pengantin'" x-data="{ penjemput: '{{ $kadData->penjemput }}' }" class="mt-8 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-6 sm:grid-cols-1">
									...
									<div x-show="penjemput === '3' || penjemput === '1'" class="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-8">
										<div class="sm:col-span-1">
											...
											<div class="mt-2">
												<input type="text" name="nama_bapa_pengantin_lelaki" id="nama_bapa_pengantin_lelaki" value="{{ $kadData->nama_bapa_pengantin_lelaki }}" spellcheck="false" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
											</div>
										</div>
										<div class="sm:col-span-1">
							...
							<div class="border rounded-md p-4 mb-4">
								...
								<div x-show="openSection === 'maklumat_majlis'" class="mt-8 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
									...
									<div class="sm:col-span-full">
										...
										<div class="mt-2">
											<input type="text" name="tajuk_kad" id="tajuk_kad" spellcheck="false" value="Walimatulurus" maxlength="20" value="{{ $kadData->tajuk_kad }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
										</div>
									</div>
									<!-- Ayat Jemputan -->
									...
									<div class="sm:grid-cols-1 sm:col-span-3">
										...
										<!-- Waze URL -->
										<div>
											<label for="waze_url" class="mt-2 block text-sm font-medium leading-6 text-gray-900">URL Waze</label>
											<div class="mt-1">
									...
									<div class="sm:col-span-6">
										...
										<div class="mt-2 space-y-4">
											...
											<div class="flex space-x-4">
												<input type="text" name="nama_{{ $i + 1 }}" id="nama_{{ $i + 1 }}" value="{{ $kadData->nombor_telefon[$i]['nama'] ?? '' }}" placeholder="Nama" maxlength="20" spellcheck="false" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
												<input type="text" name="nombor_telefon_{{ $i + 1 }}" id="nombor_telefon_{{ $i + 1 }}" value="{{ $kadData->nombor_telefon[$i]['nombor_telefon'] ?? '' }}" placeholder="Nombor Telefon" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
											</div>
											@endfor
										</div>
									</div>
									...
									<div class="sm:col-span-6">
										...
										<div class="mt-2 space-y-4">
											@for ($i = 0; $i < 6; $i++)
											<div class="flex space-x-4">
												<input type="time" name="masa_acara_{{ $i + 1 }}" id="masa_acara_{{ $i + 1 }}" value="{{ $kadData->aturcara_majlis[$i]['masa_acara'] ?? '' }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
												<input type="text" name="acara_{{ $i + 1 }}" id="acara_{{ $i + 1 }}" spellcheck="false" value="{{ $kadData->aturcara_majlis[$i]['acara'] ?? '' }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
											</div>
											@endfor
										</div>
									</div>
