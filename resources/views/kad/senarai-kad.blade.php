<x-app-layout>
    ...
    <div class="relative isolate mt-12 sm:mt-10 sm:pt-12">
        ...
        <div class="py-12">
            ...
            <!-- Payment Gateway Downtime Banner -->
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-6">
                <div class="bg-gradient-to-r from-orange-50 to-red-50 border-l-4 border-orange-500 rounded-lg shadow-lg p-4 sm:p-6">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <p class="text-sm sm:text-base text-orange-800 mb-3">
                                Our main payment gateway is currently experiencing technical issues. Expected full recovery: <strong>November 7th, 2025</strong>.
                            </p>
                            <p class="text-sm sm:text-base text-orange-800 mb-4">
                                <strong>Don't worry!</strong> You can still complete your payment by contacting us directly via WhatsApp. We'll process your payment manually and activate your invitation card as a paid e-card immediately.
                            </p>
                            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                                <a href="https://api.whatsapp.com/send?phone=60108323516" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg shadow-md transition-colors duration-200">
                                ...
                                <p class="text-xs sm:text-sm text-orange-700 italic">
                                    We'll activate your invitation card immediately after manual payment confirmation
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <!-- End of Payment Gateway Downtime Banner -->
