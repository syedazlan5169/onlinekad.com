...
class ZohoBooksService
{
    ...
    public function createCustomer(array $data)
    {
        ...
        $response = Http::withToken($token, 'Zoho-oauthtoken')->post('https://www.zohoapis.com/books/v3/contacts?organization_id=771239135', [
    ...
    public function createInvoice(array $data)
    {
        ...
        $response = Http::withToken($token, 'Zoho-oauthtoken')->post("https://www.zohoapis.com/books/v3/invoices?organization_id=771239135", [
            'organization_id' => config('services.zoho.org_id'),
            ...$data,
        ]);
    ...
    public function recordPayment(array $data)
    {
        ...
        $response = Http::withToken($token, 'Zoho-oauthtoken')->post("https://www.zohoapis.com/books/v3/customerpayments?organization_id=771239135", [
            'organization_id' => config('services.zoho.org_id'),
            ...$data,
        ]);
